...
public class TelaAlterar extends javax.swing.JFrame {
    ...
    public TelaAlterar() {
        ...
        telaSobreNosPanelTelaAlterar.setVisible(false);
        ...
        voltarTelaSobreNosTelaAlterar.setEnabled(false);
    ...
    private void initComponents() {
        ...
        telaSobreNosPanelTelaAlterar = new javax.swing.JPanel();
        voltarTelaSobreNosTelaAlterar = new javax.swing.JButton();
        ...
        opcoesTelaAlterar = new javax.swing.JButton();
        voltarTelaAlterar = new javax.swing.JButton();
        ...
        telaSobreNosPanelTelaAlterar.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        voltarTelaSobreNosTelaAlterar.setBorder(null);
        voltarTelaSobreNosTelaAlterar.setContentAreaFilled(false);
        voltarTelaSobreNosTelaAlterar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                voltarTelaSobreNosTelaAlterarActionPerformed(evt);
            }
        });
        telaSobreNosPanelTelaAlterar.add(voltarTelaSobreNosTelaAlterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 110, 30));

        telaSobreNosLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TELA_SOBRE_NOS.png"))); // NOI18N
        telaSobreNosPanelTelaAlterar.add(telaSobreNosLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        getContentPane().add(telaSobreNosPanelTelaAlterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1000, 560));
        ...
        opcoesTelaAlterar.setBorder(null);
        opcoesTelaAlterar.setContentAreaFilled(false);
        opcoesTelaAlterar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                opcoesTelaAlterarActionPerformed(evt);
            }
        });
        getContentPane().add(opcoesTelaAlterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 10, 100, 40));

        voltarTelaAlterar.setBorder(null);
        voltarTelaAlterar.setContentAreaFilled(false);
        voltarTelaAlterar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                voltarTelaAlterarActionPerformed(evt);
            }
        });
        getContentPane().add(voltarTelaAlterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 100, 40));
    ...
    private void voltarTelaAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_voltarTelaAlterarActionPerformed
        EfeitosSonoros.Play("back.wav");
        new TelaManterFlashcards().setVisible(true);
        this.dispose();
    }//GEN-LAST:event_voltarTelaAlterarActionPerformed
    ...
    private void opcoesTelaAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opcoesTelaAlterarActionPerformed
        ...
        opcoesTelaAlterar.setEnabled(false);
        voltarTelaAlterar.setEnabled(false);
        procurarButton.setEnabled(false);
    }//GEN-LAST:event_opcoesTelaAlterarActionPerformed

    private void voltarTelaSobreNosTelaAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_voltarTelaSobreNosTelaAlterarActionPerformed
        EfeitosSonoros.Play("back.wav");
        telaSobreNosPanelTelaAlterar.setVisible(false);
        telaSobreNosPanelTelaAlterar.setEnabled(false);
        sobreNosTelaCreditos.setVisible(true);
    }//GEN-LAST:event_voltarTelaSobreNosTelaAlterarActionPerformed
    ...
    private void sobreNosTelaCreditosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sobreNosTelaCreditosActionPerformed
        EfeitosSonoros.Play("click.wav");
        telaSobreNosPanelTelaAlterar.setVisible(true);
        voltarTelaSobreNosTelaAlterar.setEnabled(true);
    ...
    private void fecharTelaOpcoesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fecharTelaOpcoesActionPerformed
        ...
        fecharTelaOpcoes.setEnabled(false);
        creditosTelaOpcoes.setEnabled(false);
        opcoesTelaAlterar.setEnabled(true);
        voltarTelaAlterar.setEnabled(true);
    ...
    private javax.swing.JButton opcoesTelaAlterar;
    ...
    private javax.swing.JPanel telaSobreNosPanelTelaAlterar;
    private javax.swing.JButton voltarTelaAlterar;
    private javax.swing.JButton voltarTelaCreditos;
    private javax.swing.JButton voltarTelaSobreNosTelaAlterar;
